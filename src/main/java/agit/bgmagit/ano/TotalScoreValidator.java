...
public class TotalScoreValidator implements ConstraintValidator<ValidTotalScore, RecordRequestList> {
    
    private final JPAQueryFactory queryFactory;
    
    @Override
    public boolean isValid(RecordRequestList value, ConstraintValidatorContext context) {
        ...
        int sum = value
                ...
                .mapToInt(RecordRequest::getRecordScore)
                .sum();
